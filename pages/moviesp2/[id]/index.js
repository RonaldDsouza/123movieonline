...
const fetchmoviesData = async () => {
  const response = await fetch('https://123movieonline.netlify.app/moviesp2.json')
...
const moviesDetail2 = ({ moviesItem }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'Person',
        '@id': 'https://123movieonline.netlify.app/author/123moviesonline/',
        name: 'Dr Trailer',
        url: 'https://123movieonline.netlify.app/author/123moviesonline/',
        image: {
          '@type': 'ImageObject',
        ...
        sameAs: ['https://123movieonline.netlify.app']
      },
      {
        '@type': 'Article',
