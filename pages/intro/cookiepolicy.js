  ...
  return (
    <div>
      <Head>
        ...
        <link
          rel='canonical'
          href='https://123movieonline.netlify.app/intro/tearms'
        />
        ...
        <meta
          property='og:url'
          content='https://123movieonline.netlify.app/intro/tearms/'
        />
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <p style={{ color: '#666', marginBottom: '24px' }}>
                ...
                https://123movieonline.netlify.app and its subdomains.
              </p>
