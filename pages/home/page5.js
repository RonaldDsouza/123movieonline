...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movieonline.netlify.app/page5',
  headline: 'movies Section | 123Moviesonline™',
  url: 'https://123movieonline.netlify.app/page5',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movieonline.netlify.app/page5'
    }
  ]
})

const moviespage5 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 5 | 123Moviesonline™</title>
        <link rel='canonical' href='https://123movieonline.netlify.app/page5' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 5 | 123Moviesonline™' />
        <meta
        ...
        <meta property='og:url' content='https://123movieonline.netlify.app/page5' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movieonline.netlify.app/moviesp5.json')
