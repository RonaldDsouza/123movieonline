...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movieonline.netlify.app/page6',
  headline: 'movies Section | 123Moviesonline™',
  url: 'https://123movieonline.netlify.app/page6',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movieonline.netlify.app/page6'
    }
  ]
})

const moviespage6 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123movieonline.netlify.app/page6' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='https://123movieonline.netlify.app/page6' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movieonline.netlify.app/moviesp6.json')
