...
const softwareSchema = JSON.stringify({
  ...
  url: 'https://123movieonline.netlify.app/page3',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movieonline.netlify.app/page3'
    }
  ]
})
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123movieonline.netlify.app/page3' />
        <meta
          name='robots'
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movieonline.netlify.app/moviesp3.json')
