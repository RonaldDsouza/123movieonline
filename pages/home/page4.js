...
import moviesp4Data from '../../public/moviesp4.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movieonline.netlify.app/page4/',
  headline: 'movies Section | 123Moviesonline™',
  url: 'https://123movieonline.netlify.app/page4/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movieonline.netlify.app/page4/'
    }
  ]
})

const moviesPage4 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 4 | 123Moviesonline™</title>
        <link rel='canonical' href='https://123movieonline.netlify.app/page4/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 4 | 123Moviesonline™' />
        <meta
        ...
        <meta property='og:url' content='https://123movieonline.netlify.app/page4' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movieonline.netlify.app/moviesp4.json')
